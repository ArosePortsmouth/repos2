...
while gameRun == True:
    lab1 = Label(window, text = "-", borderwidth=3, relief="sunken")
    lab1.config(height = 5, width = 10)
    lab1.grid(row = 1, column = 10)

    lab2 = Label(window, text = "-", borderwidth=3, relief="sunken")
    lab2.config(height = 5, width = 10)
    lab2.grid(row = 1, column = 11)

    lab3 = Label(window, text = "-", borderwidth=3, relief="sunken")
    lab3.config(height = 5, width = 10)
    lab3.grid(row = 1, column = 12)

    lab4 = Label(window, text = "-", borderwidth=3, relief="sunken")
    lab4.config(height = 5, width = 10)
    lab4.grid(row = 2, column = 10)


    lab5 = Label(window, text = "-", borderwidth=3, relief="sunken")
    lab5.config(height = 5, width = 10)
    lab5.grid(row = 2, column = 11)


    lab6 = Label(window, text = "-", borderwidth=3, relief="sunken")
    lab6.config(height = 5, width = 10)
    lab6.grid(row = 2, column = 12)


    lab7 = Label(window, text = "-", borderwidth=3, relief="sunken")
    lab7.config(height = 5, width = 10)
    lab7.grid(row = 3, column = 10)


    lab8 = Label(window, text = "-", borderwidth=3, relief="sunken")
    lab8.config(height = 5, width = 10)
    lab8.grid(row = 3, column = 11)


    lab9 = Label(window, text = "-", borderwidth=3, relief="sunken")
